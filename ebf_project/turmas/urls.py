...
urlpatterns = [
    ...
    path('<uuid:turma_id>/criancas/', views.criancas_da_turma, name='criancas'),
    path('<uuid:turma_id>/criancas/exportar-excel/', views.exportar_criancas_excel, name='exportar_criancas_excel'),
